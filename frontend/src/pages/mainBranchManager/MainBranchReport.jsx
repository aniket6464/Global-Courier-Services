...
const MainBranchReport = () => {
  const [data, setData] = useState(null);

  useEffect(() => {
    const fetchPerformanceData = async () => {
      try {
        const response = await fetch('/api/branch/main-branch/performanceByid');
  ...
  return (
    <div className="container mx-auto p-4">
      {/* Page Title */}
      <h1 className="text-2xl font-bold text-center mb-6">Main Branch Performance Report</h1>
      ...
      <section className="mb-8 p-4 bg-white shadow-md rounded-lg">
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-blue-600 font-bold">{data.parcel_delivery_efficiency.delivery_speed.toFixed(2)} Hours</span>
          </div>
          <div className="flex justify-between items-center">
...
export default MainBranchReport;
