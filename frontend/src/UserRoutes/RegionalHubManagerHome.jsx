...
import Sidebar from '../components/sidebar/RegionalHubManagerSidebar';
import Footer from '../components/Footer';

// Importing main sections
import Dashboard from '../pages/regionalHubManager/Dashboard';
import ParcelManagement from '../routes/ParcelManagement';
import PerformanceReport from '../pages/regionalHubManager/PerformanceReport';
import CreateNewStaff from '../pages/CreateNewStaff';
import ListStaff from '../pages/ListStaff';
import Feedback from '../pages/admin/Feedback';
import Complaints from '../pages/Complaints';
import Profile from '../pages/regionalHubManager/Profile';

const RegionalHubManagerHome = () => {
  return (
...
export default RegionalHubManagerHome;
